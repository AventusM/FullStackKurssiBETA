...
//         }
//     ]
//     test('out of three blogs returns the one with the most overall', () => {
//         //Mapatan authorit
//         const sortedAuthors = listWithThreeBlogs.map(blog => blog.author).sort()
//         console.log(sortedAuthors.forEach())
//         //Filter (nimi matchaa) -> reduce (summa)
//     })
// })